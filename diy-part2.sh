...
git clone -b 18.06 https://github.com/uparrows/luci-theme-argon_armygreen.git  packages/luci-theme-argon_armygreen

git clone -b 18.06 https://github.com/Joecaicai/luci-theme-argon_armygreen.git packages/luci-theme-argon_armygreen
