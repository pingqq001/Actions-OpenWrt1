...
git clone  https://github.com/Joecaicai/luci-theme-argon_armygreen.git packages/luci-theme-argon_armygreen


git clone  https://github.com/uparrows/luci-theme-argon_armygreen.git  packages/luci-theme-argon_armygreen
